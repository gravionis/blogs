...
- Sometimes we have bigger models but often we have restrictions using best available model due reasons mentioned before. Hence we have to compensate with design patterns.
...
## Transformer Architecture: 
  ...
  - The architecture enables prediction of the next word in a sequence. They are not expected to perform for accurate mathematical computation; LLMs often use external tools (like calculators or code interpreters) to perform precise math.
